...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pages_address', 'state',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20),
                      keep_default=False)

        # Adding field 'Address.zip_code'
        db.add_column(u'pages_address', 'zip_code',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pages_address', 'state')

        # Deleting field 'Address.zip_code'
        db.delete_column(u'pages_address', 'zip_code')
