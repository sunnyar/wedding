...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PremiumTheme'
        db.create_table(u'pages_premiumtheme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('member', self.gf('django.db.models.fields.BooleanField')()),
            ('name', self.gf('django.db.models.fields.CharField')(default=('premium_theme0', 'Premium_Theme0'), max_length=100)),
        ))
        db.send_create_signal(u'pages', ['PremiumTheme'])


        # Changing field 'Theme.name'
        db.alter_column(u'pages_theme', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting model 'PremiumTheme'
        db.delete_table(u'pages_premiumtheme')


        # Changing field 'Theme.name'
        db.alter_column(u'pages_theme', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'pages.premiumtheme': {
            'Meta': {'object_name': 'PremiumTheme'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.BooleanField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'default': "('premium_theme0', 'Premium_Theme0')", 'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pages.rsvp': {
        ...
        u'pages.theme': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "('default', 'Default')", 'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pages.userprofile': {
