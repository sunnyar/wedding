...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_audiofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('audio_file', self.gf('audiofield.fields.AudioField')(ext_whitelist=['.mp3', '.wav', '.ogg'], max_length=100, blank=True)),
        ))
        db.send_create_signal(u'pages', ['AudioFile'])


    def backwards(self, orm):
        # Deleting model 'AudioFile'
        db.delete_table(u'pages_audiofile')
