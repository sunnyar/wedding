...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'pages.photoalbum': {
            'Meta': {'ordering': "['-date_added']", 'object_name': 'PhotoAlbum', '_ormbases': [u'photologue.Photo']},
