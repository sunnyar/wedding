...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pages_wedding', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('groom_first_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('groom_last_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('bride_first_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('bride_last_name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('wedding_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'pages', ['Wedding'])


    def backwards(self, orm):
        # Deleting model 'Wedding'
        db.delete_table(u'pages_wedding')
