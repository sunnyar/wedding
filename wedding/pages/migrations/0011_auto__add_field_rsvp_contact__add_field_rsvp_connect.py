...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rsvp.contact'
        db.add_column(u'pages_rsvp', 'contact',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=15),
                      keep_default=False)

        # Adding field 'Rsvp.connect'
        db.add_column(u'pages_rsvp', 'connect',
                      self.gf('django.db.models.fields.CharField')(default=('phone', 'Phone'), max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rsvp.contact'
        db.delete_column(u'pages_rsvp', 'contact')

        # Deleting field 'Rsvp.connect'
        db.delete_column(u'pages_rsvp', 'connect')
    ...
    models = {
        ...
        u'pages.rsvp': {
            ...
            'connect': ('django.db.models.fields.CharField', [], {'default': "('phone', 'Phone')", 'max_length': '15'}),
            'contact': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
        ...
        u'pages.theme': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "('default', 'Default')", 'max_length': '10'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'pages.userprofile': {
