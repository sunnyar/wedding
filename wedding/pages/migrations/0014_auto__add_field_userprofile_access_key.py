...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.access_key'
        db.add_column(u'pages_userprofile', 'access_key',
                      self.gf('django.db.models.fields.CharField')(default='0000000', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.access_key'
        db.delete_column(u'pages_userprofile', 'access_key')
    ...
    models = {
        ...
        u'pages.userprofile': {
            ...
            'access_key': ('django.db.models.fields.CharField', [], {'default': "'0000000'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
