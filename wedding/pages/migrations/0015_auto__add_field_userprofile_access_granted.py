...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.access_granted'
        db.add_column(u'pages_userprofile', 'access_granted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.access_granted'
        db.delete_column(u'pages_userprofile', 'access_granted')
